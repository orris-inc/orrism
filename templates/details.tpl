<script src="https://milus.one/modules/servers/orrism/frontend/3.4.15"></script>
<link href="https://milus.one/modules/servers/orrism/frontend/all.min.css" rel="stylesheet">
<script src="https://milus.one/modules/servers/orrism/frontend/clipboard.js"></script>
<script src="https://milus.one/modules/servers/orrism/frontend/layer.min.js"></script>
<style>
    .section-title {
...
<div id="kurenai_ss_manage" systemurl="{$systemurl}" class="p-2 sm:p-4">
    <div class="max-w-7xl mx-auto">
        <div class="bg-white shadow-xl rounded-xl p-4 sm:p-6 text-gray-700">
            ...
            <h2 class="section-title text-lg sm:text-xl font-semibold text-gray-900">
                <i class="fa-solid fa-history mr-2 text-indigo-500"></i>{ORRISM_L::client_subscription_records}
            </h2>
                        ...
                        <thead class="bg-gray-50">
                            <tr>
                                <th scope="col" class="px-3 sm:px-6 py-2 sm:py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                    {ORRISM_L::client_access_time}
                                </th>
                                <th scope="col" class="px-3 sm:px-6 py-2 sm:py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                    {ORRISM_L::client_ip_address}
                                </th>
                                <th scope="col" class="px-3 sm:px-6 py-2 sm:py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                    {ORRISM_L::client_app_type}
                                </th>
                            </tr>
                        </thead>
        ...
        <div class="flex flex-col p-4 sm:p-6 bg-white shadow-lg rounded-xl dialog-mark-2 max-w-md mx-auto m-4">
            ...
            <div class="grid gap-2 sm:gap-3 grid-cols-2">
                ...
                <button id="Choc" class="hidden w-full col-span-2 inline-flex justify-center items-center px-3 sm:px-4 py-2 border border-gray-300 shadow-sm text-xs sm:text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                    ...
                    {ORRISM_L::client_import_to_choc}
                </button>
            </div>
        </div>
    </div>
...
<script>
    ...
    function set_url(obj){
        ...
        switch (true) {
            case obj.id === 'Clash':
                ...
                copy_button.innerHTML = '<i class="fa-solid fa-copy mr-1 sm:mr-2 text-gray-500"></i>{ORRISM_L::client_copy_subscribe_url}';
                one_click.innerHTML = '<i class="fa-solid fa-file-import mr-1 sm:mr-2"></i>{ORRISM_L::client_import_to_clash}';
                break;
            case obj.id === 'Surge':
    ...
    $(document).mouseup(function(e){
        ...
        if(!_con.is(e.target) && _con.has(e.target).length === 0){ // Mark 1
            ...
            copy_button.innerHTML = '<i class="fa-solid fa-copy mr-1 sm:mr-2 text-gray-500"></i>{ORRISM_L::client_copy}';
            one_click.innerHTML = '<i class="fa-solid fa-file-import mr-1 sm:mr-2"></i>{ORRISM_L::client_import}';
        }
    });
    
    var clipboard = new ClipboardJS('.copy');
    clipboard.on('success', function (e) {
        layer.msg('{ORRISM_L::client_copy_success}')
        console.log(e);
    });
